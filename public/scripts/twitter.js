    ...
    callback: function (a) {
      ...
      if (u)
        for (c = c.getElementsByClassName("tweet"); e <
          ...
          if (!b[e] || b[e] && z) a.push(c[e].getElementsByClassName("e-entry-title")[0]), n.push(c[e].getAttribute("data-tweet-id")), f.push(c[e].getElementsByClassName("p-author")[0]), g.push(c[e].getElementsByClassName("dt-updated")[0]),
          ...
          for (c = m(c, "tweet"); e < c.length;) a.push(m(c[e], "e-entry-title")[0]),
            n.push(c[e].getAttribute("data-tweet-id")), f.push(m(c[e], "p-author")[1]), g.push(m(c[e], "dt-updated")[0]), void 0 !== m(c[e], "inline-media")[0] ? h.push(m(c[e], "inline-media")[0]) : h.push(void 0), 0 < m(c[e], "retweet-credit")
            .length ? b.push(!0) : b.push(!1), e++;
      ...
      for (b = 0; b < e;) {
        ...
        d = "";
        y ? (d += '<p class="tweet__content">' + '<span class="tweet__user">' + w(f[b].innerHTML) + ':</span>' + w(a[b].innerHTML) + "</p>", q) : a[b].innerText ? (r && (d += '<p class="tweet__user">' + f[b].innerText + "</p>"), d +=
          '<p class="tweet__content">' + a[b].innerText + "</p>", q && (d += '<p class="tweet__timePosted">' + g[b].innerText + "</p>")) : (r && (d += '<p class="tweet__user">' + f[b].textContent + "</p>"), d += '<p class="tweet">' + a[b]
          .textContent + "</p>", q && (d += '<p class="tweet__timePosted">' + g[b].textContent + "</p>"));
        A && (d += '<ul class="tweet__footer">' + '<li><span class="tweet__timePosted">' + g[b].innerHTML + "</span></li>" + '<li><a href="https://twitter.com/intent/tweet?in_reply_to=' + n[b] +
          '">Reply</a></li><li><a href="https://twitter.com/intent/retweet?tweet_id=' + n[b] + '">Retweet</a></li><li><a href="https://twitter.com/intent/favorite?tweet_id=' +
          n[b] + '">Favorite</a></li></ul>');
        B && void 0 !== h[b] && (l = h[b], void 0 !== l ? (l = l.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0], l = decodeURIComponent(l).split('"')[1]) : l = void 0, d += '<div class="media"><img src="' + l +
      ...
      if (null === v) {
        ...
        for (h = "<ul class='twitterfeed'>"; f < a;) h += "<li class='tweet'>" + c[f] + "</li>", f++;
        g.innerHTML = h + "</ul>"
      } else v(c);
      s = !1;
